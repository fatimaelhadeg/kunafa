  ...
  return (
    <footer className="bg-orange-100 dark:bg-[#1F1D2B] text-black dark:text-white pt-16 pb-10 px-6 lg:px-20 transition-colors duration-300">
      <div className="grid md:grid-cols-4 gap-10">
        {/* Logo & Description */}
        <div>
          <h2 className="text-2xl font-bold text-orange-500 mb-4">BaklaVa's Kitchen</h2>
          <p className="text-gray-700 dark:text-gray-300">
            Your BaklaVa's Kitchen app for delicious and fast food delivery. Taste the joy
            at your doorstep.
          </p>
