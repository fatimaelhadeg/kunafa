...
const FoodsList = () => {
  ...
  return (
    ...
    <div className='w-full mx-auto px-6 text-center mt-20'>
      ...
      <div className='grid gridd-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
        {Foods.map((Food)=>{
          ...
          <img src={image} alt="" className='h-100 w-full object-contain rounded-lg transform scale-90 hover:scale-100  transition-transform duration'/>
          <div className='mt-4'>
