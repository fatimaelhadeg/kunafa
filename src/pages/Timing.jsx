...
const fullWeekTimings = [
  { day: "Lundi", time: "09:00 - 21:00" },
  { day: "Mardi", time: "09:00 - 21:00" },
  { day: "Mercredi", time: "09:00 - 21:00" },
  { day: "Jeudi", time: "09:00 - 21:00" },
  { day: "Vendredi", time: "09:00 - 21:00" },
  { day: "Samedi", time: "09:00 - 21:00" },
  { day: "Dimanche", time: "09:00 - 21:00" },
];

const specialTimings = [
  { title: "Spécial Week-end", time: "10:00 - 22:00" },
];
  ...
  return (
    <div className="bg-white dark:bg-[#1F1D2B] py-16 px-6 lg:px-20 rounded-3xl mx-4 lg:mx-16 
      ...
      <div className="flex flex-col md:flex-row justify-center items-start gap-12 max-w-6xl mx-auto">
        ...
        {/* Centre: Cercle avec hover et transition */}
        <motion.div
          initial={{ scale: 0 }}
          whileInView={{ scale: 1 }}
